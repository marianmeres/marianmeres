...
## 9. Migration: CLAUDE.md → AGENTS.md

> Temporary: Execute when package has both files or only CLAUDE.md.

1. Read both `AGENTS.md` and `CLAUDE.md`
2. Merge unique content from `CLAUDE.md` into `AGENTS.md` (CLAUDE.md may be outdated)
3. Delete old `CLAUDE.md`
4. Run: `cp /Users/mm/projects/@marianmeres/marianmeres/mm-local-docs/CLAUDE_TEMPLATE.md CLAUDE.md`

**Skip if**: CLAUDE.md already redirects to AGENTS.md, or doesn't exist.
